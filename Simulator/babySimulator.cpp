...
int BabySimulator::fetch() {
	...
	cout << "Incremented control instruction." << endl;

	cout << "Present instruction is: ";
...
int BabySimulator::decode() {
	...
	switch (PI) {
		case 0:
			cout << "Decoded instruction is: JMP" << endl;
			return JMP;
			break;
		case 1:
			cout << "Decoded instruction is: JRP" << endl;
			return JRP;
			break;
		case 2:
			cout << "Decoded instruction is: LDN" << endl;
			return LDN;
			break;
		case 3:
			cout << "Decoded instruction is: STO" << endl;
			return STO;
			break;
		case 4:
			cout << "Decoded instruction is: SUB" << endl;
			return SUB;
			break;
		case 5:
			cout << "Decoded instruction is: SUB" << endl;
			...
			break;
		case 6:
			cout << "Decoded instruction is: CMP" << endl;
			return CMP;
			break;
		case 7:
			cout << "Decoded instruction is: STP" << endl;
			return STP;
			break;
	}
...
int BabySimulator::jmp(int line) {
	cout << "Executing JMP on line: " << line << endl;
...
int BabySimulator::jrp(int line) {
	cout << "Executing JRP on line: " << line << endl;
...
int	BabySimulator::ldn(int line) {
	cout << "Executing LDN on line: " << line << endl;
...
int	BabySimulator::sto(int line) {
	cout << "Executing STO on line: " << line << endl;
...
int	BabySimulator::sub(int line) {
	cout << "Executing SUB on line: " << line << endl;
